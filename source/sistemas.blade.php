...
<div class="container">
    ...
    <div class="row">
        <div class="col-sm-6 col-md-3">
            <div class="thumbnail">
                <img src="img/logo_escolas.png" alt="Logo Monitor de Clima CEAP" style="width: 99px;">
                <div class="caption">
        ...
        <div class="col-sm-6 col-md-3">
            <div class="thumbnail">
                <img src="img/rsz_nextcloud.png" alt="Logo Nextcloud">
                <div class="caption">
                    <h3>Nextcloud</h3>
        ...
        <div class="col-sm-6 col-md-3">
            <div class="thumbnail">
                <img src="img/rsz_kanboard.png" alt="Logo Kanboard">
                <div class="caption">
                    <h3>Kanboard</h3>
        ...
        <div class="col-sm-6 col-md-3">
            <div class="thumbnail">
                <img src="img/rsz_limesurvey.png" alt="Logo Limesurvey">
                <div class="caption">
                    <h3>LimeSurvey</h3>
